...
# Model
model = LSTMDetector(vocab_size, vector_size).to(device)
...
writer = SummaryWriter('../../runs/MLP_detector')
...
for epoch in range(num_epochs):
    ...
    writer.add_scalar('Loss/valid', avg_loss, 1 + epoch_number)
...
torch.save({'epoch': epoch_number, 'model_state_dict': model.state_dict(), 'optimizer_state_dict': optimizer.state_dict(),
            'loss': avg_loss}, "../../reproduction/models/LSTM_detector.pth")